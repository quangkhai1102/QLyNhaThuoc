...
namespace medicine_store.forms
{
    ...
    {
        private static readonly string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""D:\CNTT NĂM 2\Lập Trình Trên DESKTOP\QLyNhaThuoc (1)\Database1.mdf"";Integrated Security=True";
