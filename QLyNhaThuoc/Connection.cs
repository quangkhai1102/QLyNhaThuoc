...
namespace QLyNhaThuoc
{
    internal class Connection // Định nghĩa lớp Connection, chỉ có thể truy cập từ trong cùng một assembly
    {
        ...
        private static string stringConnection = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""D:\Visual Studio\Code\QLyNhaThuoc\Database1.mdf"";Integrated Security=True";
